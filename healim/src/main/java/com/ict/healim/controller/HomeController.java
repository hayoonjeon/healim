...
public class HomeController {
	...
	public ModelAndView hospitalIntro(Model model, HttpSession session) {
...
// ********************* �?리자 ?��?��?���? �??�� 컨트롤러 **********************************
	...
	public ModelAndView directToCounselor() {
		return new ModelAndView("admin_pages/counselor");
	}
	...
	public ModelAndView directToHospitalInfo() {
		return new ModelAndView("admin_pages/hospital_info");
	}

	@GetMapping("/hospital_reg")
	public ModelAndView directToHospitalReg() {
		return new ModelAndView("admin_pages/hospital_reg");
	}
	...
	public ModelAndView directToFreeBoard() {
		return new ModelAndView("admin_pages/freeboard");
	}

	@GetMapping("/hospital_edit")
	public ModelAndView directToHospitalEdit() {
		return new ModelAndView("admin_pages/hospital_edit");
	}
	...
	@GetMapping("/announcement_edit")
	public ModelAndView directToAnnouncementEdit() {
		return new ModelAndView("admin_pages/announcement_edit");
	}
