        ...
        <c:choose>
            <c:when test="${not empty sessionScope.sessionUser}"> <!-- 사용자가 로그인한 경우 -->
                ...
                <c:if test="${sessionScope.sessionUser.user_level == 'S' || sessionScope.sessionUser.user_level == 'A'}"> <!-- 관리자 확인 -->
                    <li><a href="/admin_index">관리자 페이지</a></li>
                </c:if>
            </c:when>
...
대상으로 서비스를 제공합니다.</p>
	...
	<div class="pick-section">
		...
		<div class="pick-container">
			<!-- 카드 1 -->
			<a href="/hospitalDetail" class="pick-card">
				<img src="/resources/img/5.jpg" alt="김제 요양병원"   >
				<div class="tags">
					<span>물리치료</span> <span>양/한방</span>
				</div>
				<div class="title">(의) 예림의료재단 김제요양병원</div>
			</a>

			<!-- 카드 2 -->
			<a href="/hospitalDetail" class="pick-card">
				<img src="/resources/img/6.jpg" alt="김제 요양병원" >
				<div class="tags">
					<span>물리치료</span> <span>양/한방</span>
				</div>
				<div class="title">(의) 예림의료재단 김제요양병원</div>
			...
			<!-- 카드 3 -->
			<a href="/hospitalDetail" class="pick-card">
				<img src="/resources/img/9.jpg" alt="김제 요양병원">
				<div class="tags">
					<span>물리치료</span> <span>양/한방</span>
				</div>
				<div class="title">(의) 예림의료재단 김제요양병원</div>
			...
			<!-- 카드 4 -->
			<a href="/hospitalDetail" class="pick-card">
				<img src="/resources/img/10.jpg" alt="김제 요양병원" >
				<div class="tags">
					<span>물리치료</span> <span>양/한방</span>
				</div>
				<div class="title">(의) 예림의료재단 김제요양병원</div>
