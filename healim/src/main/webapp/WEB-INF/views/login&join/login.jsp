	...
	<div class="container">
		...
		<div class="social-login">
			...
			<div class="social-icons">
				<a href="https://kauth.kakao.com/oauth/authorize?client_id=fc0f2a1e052696d852c1539b4d217b28&redirect_uri=http://15.165.237.2/kakaologin&response_type=code" target="_blank"> <img
					src="resources/img/kakao.jpg" alt="KakaoTalk"
					style="border-radius: 10px;">
				</a> <a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=pkOdTrbseb_iSEoDm8uF&redirect_uri=http://15.165.237.2/naverlogin&state=SPRING-TEST" target="_blank"> <img
