...
<body>
	...
	<!-- 	<div class="facility-list active" id="hospitalList">
		...
		<div class="facility-item" onclick="location.href='/hospitalDetail'">
			...
			<div class="facility-details">
				<h3>송파그랜드요양병원</h3>
				<p>서울특별시 송파구 마천로 238, 윤진프라자타워</p>
				<div>
					<span class="rounded-box">2등급</span> <span class="rounded-box">대형</span>
					<span class="rounded-box">설립 5년</span>
				</div>
			</div>
		</div>
	</div> -->
	...
	<c:forEach var="k" items="${list3}">
		<div class="facility-list active" id="hospitalList">
			<div class="facility-item" onclick="location.href='/hospitalDetail?h_id=${k.h_id}&cPage=${paging.nowPage}'">
				<img src="/resources/img/8.jpg" alt="시설 이미지" class="facility-img">
				<div class="facility-details">
					<h3>${k.h_name}</h3>
					<p>${k.addr}</p>
