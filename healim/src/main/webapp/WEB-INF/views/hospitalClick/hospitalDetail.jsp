...
<script>
  Kakao.init('802825deb6634601e0e838a216dbd854'); // 사용하려는 앱의 JavaScript 키 입력
</script>
...
<br>
     <!-- Kakao Maps API 스크립트 -->
      <script type="text/javascript"
         src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=802825deb6634601e0e838a216dbd854&libraries=services&autoload=false"></script>
      <script type="text/javascript">
