...
<div class="hospital-intro">
    ...
    <section class="hospital-header">
        ...
        <div class="hospital-info">
            <span class="badge">${hvo.grade}</span>
            <span class="badge">설립 일 : ${hvo.open_date}</span>
        </div>

        <!-- 찜하기, 위치보기, 공유하기 버튼 -->
        <div class="button-group">
            <button class="button" onclick="alert('찜하기')">찜하기</button>
...
<!--     운영 정보
    ...
    <section class="map-section">
        <h2>위치보기</h2>
        <p>${hvo.addr}</p>
        <img src="/path/to/map-image.png" alt="병원 위치 지도" class="map-image">
    </section>
