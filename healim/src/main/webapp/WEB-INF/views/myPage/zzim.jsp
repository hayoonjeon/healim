...
<body>
	...
	<div class="container">
		...
		<div class="facility-list active" id="hospitalList">
			<p id="hospitalCount">총 0개의 시설이 있어요</p>

			<!-- 병원 정보 예시 -->
			<div class="facility-item">
				<img src="resources/img/5.jpg" alt="병원 이미지"
					onclick="location.href='/hospitalDetail'">
				<div class="facility-details"
					onclick="location.href='/hospitalDetail'">
					<h3>오케이요양병원</h3>
					<p>서울 구로구 중앙로 64 고척프라자 가동 4층, 나동 3,4층</p>
				</div>
				<img src="resources/img/heart11.jpg" alt="찜 하트" class="heart"
		...
		<div class="facility-list" id="homeList">
			<p id="homeCount">총 0개의 시설이 있어요</p>
			...
			<div class="facility-item">
				...
				<img src="resources/img/heart11.jpg" class="heart"
					onclick="toggleHeart(this)">
			</div>
