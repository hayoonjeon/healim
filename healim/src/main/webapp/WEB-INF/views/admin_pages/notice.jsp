...
<!-- 메인 테이블--------------------------------------------------------------------------- -->
    ...
    <div class="top2">
        ...
        <ul class="menu">
          ...
          <li  style="background-color: ;" onclick="location.href='/notice';">공지사항</li>
	        ...
	        <table>
	          ...
	          <tbody>
	            <tr>
	              ...
	              <td>
					<input type="button" value="수정" onclick="location.href='/announcement_edit';">
        ...
        <form action="" method="post">
	        <div class="gray_bt">
	          ...
	          <input type="button" value="생성" onclick="location.href='/announcement';">
	        </div>
        </form>
      </section>
