    ...
    <div class="top2">
        <div class="top2text">
            ...
            <table class="">
                <thead> 
                    <tr class="headrow">
                        <th  class="firsthead">구분</th><th colspan="3">내 용</th>
                    </tr>
                </thead>
                <tbody>
                    
                    <tr>
                        <td>기관명</td><td colspan="3"> <input class="titleinput" type="text" placeholder="여기에 제목이 들어갑니다."></td>
                    </tr>
                    <tr>
                        <td>지역</td><td><input type="text"></td><td >주소</td><td><input type="text"></td>
                    </tr>
                    <tr>
                        <td>등급</td>
                        <td>
                        ...
                        <td >병상정보</td><td><input type="text"></td>
                    </tr>
                    <tr>
                        <td>의료정보</td><td><input type="text"></td><td>진료부서</td><td><input type="text"></td>
                    </tr>
                    
                    <tr>
                    <td>기타</td>
                    <td colspan="3"><textarea cols="150" rows="20" placeholder="추가 사항을 입력해 주세요"></textarea></td>
                    </tr>
                    <tr>
                       	<td>첨부파일</td><td colspan="3"><div class="preview"></div> <input type="file"><input type="reset">삭제 </td>
                    </tr>
                    <tr>
                        <td colspan="4"><input type="submit" value="등록"><button id="button1" type="reset" onclick="location.href='/hospital_info'">취소</button></td>
                    </tr>
