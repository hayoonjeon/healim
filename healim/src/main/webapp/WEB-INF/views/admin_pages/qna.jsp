    ...
    <div class="top2">
        <div class="top2text">
            ...
            <table class="">
                <thead> 
                    <tr class="headrow">
                        <th colspan="2" class="firsthead">구분</th><th colspan="2">문의사항</th>
                    </tr>
                </thead>
                <tbody>
                    
                    <tr>
                        <td colspan="2">제목</td><td colspan="2"> <input class="titleinput" type="text" placeholder="여기에 제목이 들어갑니다."></td>
                    </tr>
                    <tr>
                        <td colspan="2">내용</td><td colspan="2"><Textarea  rows="15" cols="100" placeholder="여기에 내용이 들어갑니다."></Textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">답변 내용</td><td colspan="2"><Textarea  rows="15" cols="100" placeholder="여기에 내용이 들어갑니다."></Textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">첨부파일</td><td><input type="file"> <input type="reset" value="삭제"></td><td><input type="file"><input type="reset" value="삭제"></td>
                    </tr>
                    <tr>
